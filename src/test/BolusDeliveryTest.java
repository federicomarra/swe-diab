...
public class BolusDeliveryTest {
    ...
    public void ConstructorTest() {
        ...
        Assert.assertEquals(LocalTime.now().getHour(), bd0.time.getHour(), 0.01);
        Assert.assertEquals(LocalTime.now().getMinute(), bd0.time.getMinute(), 0.01);
        ...
        Assert.assertEquals(LocalTime.now().getHour(), bd1.time.getHour(), 0.01);
        Assert.assertEquals(LocalTime.now().plusMinutes(delay).getMinute(), bd1.time.getMinute(), 0.01);
        Assert.assertEquals(LocalTime.now().getSecond(), bd1.time.getSecond(), 0.01);
        ...
        Assert.assertEquals(LocalTime.now().getHour(), bd2.time.getHour(), 0.01);
        Assert.assertEquals(LocalTime.now().getMinute(), bd2.time.getMinute(), 0.01);
        ...
        Assert.assertEquals(LocalTime.now().getHour(), bd3.time.getHour(), 0.01);
        Assert.assertEquals(LocalTime.now().getMinute(), bd3.time.getMinute(), 0.01);
